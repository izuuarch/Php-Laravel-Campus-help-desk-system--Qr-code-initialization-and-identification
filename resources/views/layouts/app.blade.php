...
<head>
    ...
    <link href="{{ asset('css/tooplatestyle.css') }}" rel="stylesheet">
    <style>
        ul li a{
            color: white;
        }
...
<body>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background: black; color: white;">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}" style="color: white">
                    {{ config('app.name', 'COOU HELP DESK SYSTEM') }}
                </a>
